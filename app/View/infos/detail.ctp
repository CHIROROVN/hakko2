<table width="960" border="0" align="center" cellpadding="5" cellspacing="0">
  <tbody>
    <tr>
      <td width="150%" class="col_1">■八幸 Website 管理画面　＞　「新着情報」管理　＞　登録済み情報の詳細</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td align="center"><input type="button" name="button2" id="button2" value="変更する" onClick="location.href='<?php echo $this->Html->url(array('controller'=>'infos','action'=>'edit', 'id'=>$info['Info']['info_id'])) ?>'">
      <input type="button" name="button" id="button" value="削除する" onClick="location.href='<?php echo $this->Html->url(array('controller'=>'infos','action'=>'delete', 'id'=>$info['Info']['info_id'])) ?>'"></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
    </tr>
