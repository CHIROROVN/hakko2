<table width="960" border="0" align="center" cellpadding="5" cellspacing="0">
  <tbody>
      ...
      <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
          <tbody>
            ...
            <tr>
              ...
              <td>2017年11月1日17時11分<br></td>
            </tr>
            <tr>
              <td width="15%" class="col_3">終了日時：</td>
              <td>2017年11月30日17時11分</td>
            </tr>
          </tbody>
        </table></td>
    </tr>
    ...
    <tr>
      <td align="center"><input type="button" name="button2" id="button2" value="変更する（確認済み）" onClick="location.href='info_regist_end.html'">
      <input type="button" name="button" id="button" value="もどる" onClick="location.href='info_change.html'"></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
    </tr>
