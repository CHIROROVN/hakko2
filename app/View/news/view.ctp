...
<div id="second">
  ...
  <div class="clear wnCont">
    <p><?php if(!empty($info['News']['info3_img'])){?><?php echo $this->Html->image('../'.$info['News']['info3_img'], array('class' => 'alignright','width'=>'300','height'=>'auto', 'alt'=>$info['News']['info_title']));?><?php }?><?php  echo nl2br($info['News']['info3_contents']);?></p>
  </div>
  <ul class="wnDetail">
